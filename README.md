...
This repository contains the source code for the [LmisAssist](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.lmis.app.mobile).

Please see the [issues](https://github.com.lmis.app.mobile/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about LmisAssist? Ask away on the [com-lmis-app-mobile discussion forum](https://groups.google.com/forum/#!forum/com-lmis-app-mobile). 

<a href="https://play.google.com/store/apps/details?id=com.lmis.app.mobile" alt="Download from Google Play">
...
After generating the app on [AndroidBootstrap.com](http://www.androidbootstrap.com) the folder structure of the source code for the app will change:
  ...
  - From: __com.lmis.app.mobile__ 
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.lmis.app.mobile__ will be moved to the new folder __com/notify/app/mobile__. 

All import statments that reference the old resources (__R.com.lmis.app.mobile.R__) will now be renamed to the correct package. The artifact id's in the *pom.xml* (and various other places) will be replaced. The App Name will be replaced in the strings/etc. 
...
signed with a different key.  Manually uninstall LmisAssist from your device and
...
You can then import the LmisAssist project by doing File/Import/Gradle/Gradle Project
and the clicking the Browse button to point to the LmisAssist directory.  Click
...
LmisAssist is a result of a template project I've developed over the years as well as
...
LmisAssist is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.lmis.app.mobile/contributors) on this project. Your help is much appreciated.


## Contributing

Please fork this repository and contribute back using
[pull requests](https://github.com.lmis.app.mobile/pulls).
