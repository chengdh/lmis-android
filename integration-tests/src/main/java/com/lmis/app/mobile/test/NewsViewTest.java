...
import com.lmis.app.mobile.support.News;
import com.lmis.app.mobile.addons.CarouselActivity;
...
public class NewsViewTest extends ActivityInstrumentationTestCase2<CarouselActivity> {
    ...
    /**
     * Create test for {@link com.lmis.app.mobile.addons.CarouselActivity}
     */
    public NewsViewTest() {
